...
unix{
 ...
 LIBS += -lmetartc3  -lmetartccore3 -lspeexdsp -lavutil -lavcodec -lpthread -lasound -ldl -lssl2 -lcrypto2  -lsrtp2
}
win32{
    DEFINES += __WIN32__
    DEFINES +=_AMD64_
    ...
    LIBS +=  -lmetartc3  -lmetartccore3 -lspeexdsp -lwinmm -ldmoguids -lole32 -lStrmiids -lsrtp2
