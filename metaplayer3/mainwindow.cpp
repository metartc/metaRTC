    ...
    , ui(new Ui::MainWindow)
{
   ...
   // m_videoWin=new YangMouseListenWidget(this);
    ...
    m_ini->avinfo.rtc.mixAvqueue=0;
    m_ini->avinfo.sys.mediaServer=Yang_Server_Srs;//Yang_Server_Srs/Yang_Server_Zlm
    ...
    char sip[64]={0};
    char s[128]={0};
    yang_getLocalInfo(sip);
    sprintf(s,"webrtc://%s/live/livestream",sip);
    yang_trace("\nurl===%s",s);
    ui->m_url->setText(s);
    localPort=16005;
