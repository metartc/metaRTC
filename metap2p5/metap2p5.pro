...
unix{
 ...
 LIBS += -L$$HOME_BASE/thirdparty/lib -lmetaiot5 -lmetartc5  -lmetartccore5  -lyuv -lopus -lopenh264 -lspeexdsp -lusrsctp -lpthread -lasound -ldl
#openssl
...
win32{
    ...
    LIBS += -lmetaiot5 -lmetartc5 -lmetartccore5 -lyuv -lopus -lopenh264  -lspeexdsp -lavutil -lavcodec -lusrsctp -lksuser -lwinmm  -lole32 -lStrmiids
