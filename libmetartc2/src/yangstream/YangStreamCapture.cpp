...
YangAudioCodec YangStreamCapture::getAudioType(){
...
void YangStreamCapture::setVideoData(YangFrame* videoFrame,YangVideoCodec videoType){
	m_video.setVideoData(videoFrame,videoType);
}
void YangStreamCapture::setVideoMeta(uint8_t* p,int32_t plen,YangVideoCodec videoType){
...
void YangStreamCapture::initAudio(int32_t transType,int32_t sample,int32_t channel,YangAudioCodec audioType){
