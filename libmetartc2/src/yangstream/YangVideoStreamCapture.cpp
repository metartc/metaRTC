...
void YangVideoStreamCapture::initEncType(YangVideoCodec videoType,
		int32_t frametype) {
	if (frametype == 1) {
...
void YangVideoStreamCapture::setVideoData(YangFrame* videoFrame,	YangVideoCodec videoType) {
	if(m_transType==Yang_Webrtc){
...
void YangVideoStreamCapture::setVideoMeta(uint8_t *p, int32_t plen, YangVideoCodec videoType) {
