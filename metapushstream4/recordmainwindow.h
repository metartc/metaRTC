...
#include <screen/YangScreenSocket.h>
QT_BEGIN_NAMESPACE
namespace Ui { class RecordMainWindow; }
QT_END_NAMESPACE
#define Yang_SendVideo_ 0
class RecordMainWindow : public QMainWindow,public YangScreenEventI,public YangSysMessageI,public YangSysMessageHandleI
{
    Q_OBJECT
...
public:
   ...
   // YangPushHandle *m_rec;
    ...
    YangScreenSocket* m_screenServer;
