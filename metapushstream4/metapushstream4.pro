...
unix{
 ...
 LIBS += -L$$HOME_BASE/thirdparty/lib -lmetartc4  -lmetartccore4 -lyuv -lopenh264 -lspeexdsp -lopus -lusrsctp -lpthread -lasound -ldl
#openssl
...
win32{
    ...
    LIBS += -lmetartc4  -lmetartccore4 -lyuv -lopenh264 -lspeexdsp -lopus -lavutil -lavcodec -lusrsctp -lksuser -lwinmm  -lole32 -lStrmiids
    #gpu encode and decode
    #LIBS +=  -lyangwincodec4  -ld3d11 -ld3d9 -ldxva2
    #using vr
    #LIBS += -lyangrtcext2
...
SOURCES += \
    ...
    screen/YangScreenSocket.cpp \
    screen/rtcmessage.cpp \
    screen/yangscreenevent.cpp \
...
HEADERS += \
    recordmainwindow.h \
    screen/YangScreenSocket.h \
    screen/rtcmessage.h \
    screen/yangscreenevent.h \
