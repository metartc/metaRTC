...
unix{
 ...
 LIBS += -L$$HOME_BASE/thirdparty/lib -lmetartc4  -lmetartccore4 -lopenh264 -lspeexdsp -lpthread -lasound -ldl
#openssl
...
win32{
    ...
    LIBS += -lmetartc4  -lmetartccore4 -lopenh264 -lspeexdsp -lksuser -lwinmm  -lole32 -lStrmiids
