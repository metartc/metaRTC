...
unix{
 ...
 LIBS += -L$$HOME_BASE/thirdparty/lib -lmetartc4  -lmetartccore4  -lyuv -lopus -lopenh264 -lspeexdsp -lusrsctp -lpthread -lasound -ldl
#openssl
...
win32{
    ...
    LIBS += -lmetartc4  -lmetartccore4 -lyuv -lopus -lopenh264  -lspeexdsp -lavutil -lavcodec -lusrsctp -lksuser -lwinmm  -lole32 -lStrmiids
