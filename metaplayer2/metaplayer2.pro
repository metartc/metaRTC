...
unix{
 ...
 LIBS += -lmetartc2  -lmetartccore2 -lavutil -lavcodec -lpthread -lasound -ldl -lssl2 -lcrypto2  -lsrtp2
}
win32{
    DEFINES += __WIN32__
    DEFINES +=_AMD64_
    ...
    LIBS +=  -lmetartc2  -lmetartccore2 -lwinmm -ldmoguids -lole32 -lStrmiids -lsrtp2
