...
int32_t YangH264EncoderSoft::init(YangVideoInfo *pvp, YangVideoEncInfo *penc) {
	...
	int32_t x264Format =
			pvp->bitDepth == 8 ? X264_CSP_I420 : X264_CSP_HIGH_DEPTH;
	//x264_picture_alloc
...
int32_t YangH264EncoderSoft::encode(YangFrame* pframe, YangEncoderCallback* pcallback) {
	...
	for (int32_t i = 0; i < m_i264Nal; i++) {
		...
		if (m_hasHeader && isKeyFrame) {
			...
			memcpy(m_vbuffer + destLength + 4, m_nal + nal_len,
	...
	yang_trace("%d:%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x",
			destLength,	temp[i++],temp[i++],temp[i++],temp[i++],temp[i++],temp[i++],temp[i++],temp[i++],temp[i++],temp[i++],
