...
int YangPlayerHandleImpl::play(string url) {
	//m_url.app="";
    ...
    if(m_url.netType ==Yang_Webrtc){
        ...
        return playRtc(0,m_url.server,m_url.server,1985,m_url.app,m_url.stream);
...
int32_t YangPlayerHandleImpl::playRtc(int32_t puid,std::string localIp,std::string server, int32_t pport,std::string app,std::string stream){
