...
INCLUDEPATH += $$HOME_BASE/libmetartc8/src
...
macx{
 ...
 LIBS += -lmetartc8 -lyangwhip8 -lmetartccore8 -lyangutil8 -lyuv -lspeexdsp -lopus  -lusrsctp -lpthread  -ldl -lavutil -lavcodec
...
win32{
    ...
    LIBS += -lmetartc8 -lyangwhip8 -lmetartccore8 -lyangutil8 -lyuv -lspeexdsp -lopenh264 -lopus -lusrsctp -lavutil -lavcodec -lwinmm -ldmoguids -lole32 -lStrmiids
