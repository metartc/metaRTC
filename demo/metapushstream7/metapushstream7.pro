...
macx{
 ...
 LIBS += -L$$HOME_BASE/thirdparty/lib -lmetartc7 -lyangwhip7 -lmetartccore7 -lyuv -lopenh264 -lspeexdsp -lopus -lusrsctp -lpthread  -ldl
...
win32{
    ...
    LIBS += -lmetartc7 -lyangwhip7  -lmetartccore7 -lyuv -lopenh264 -lspeexdsp -lopus -lavutil -lavcodec -lusrsctp -lksuser -lwinmm  -lole32 -lStrmiids
