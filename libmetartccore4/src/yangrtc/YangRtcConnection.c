...
void yang_do_request_keyframe(YangRtcContext *context, uint32_t ssrc) {
	...
	if (context && context->streamConf && context->streamConf->rtcCallback.sendRequest)
		context->streamConf->rtcCallback.sendRequest(context->streamConf->rtcCallback.context,context->streamConf->uid, ssrc,
