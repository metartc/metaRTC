...
int32_t yang_mediadesc_parse_attr_candidate(YangMediaDesc *desc, char *value) {
	int32_t err = Yang_Ok;
	//candidate:0 1 udp 2130706431 192.168.0.103 8000 typ host generation 0 //srs
	//candidate:udpcandidate 1 udp 100 192.168.0.103 8000 typ host //zlm
	//int32_t isSrs=strstr(value,"generation")==NULL?0:1;
	YangStrings str;
	yang_cstr_split(value, " ", &str);
	if(str.vsize<8) {
		yang_destroy_strings(&str);
