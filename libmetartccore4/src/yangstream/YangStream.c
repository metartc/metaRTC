...
void yang_stream_init(YangStreamContext* context,YangStreamConfig* pconf){
		...
		context->streamconfig.recvcb.context=pconf->recvcb.context;
		context->streamconfig.recvcb.receiveAudio=pconf->recvcb.receiveAudio;
		context->streamconfig.recvcb.receiveMsg=pconf->recvcb.receiveMsg;
		context->streamconfig.recvcb.receiveVideo=pconf->recvcb.receiveVideo;

		context->streamconfig.sslCallback.context=pconf->sslCallback.context;
		context->streamconfig.sslCallback.sslAlert=pconf->sslCallback.sslAlert;
