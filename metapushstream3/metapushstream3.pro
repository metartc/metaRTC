...
unix{
 ...
 LIBS += -L$$HOME_BASE/thirdparty/lib -lmetartc3  -lmetartccore3 -lspeexdsp -lpthread -lasound -ldl
#openssl
...
win32{
    ...
    LIBS += -lmetartc3  -lmetartccore3 -lspeexdsp -lksuser -lwinmm  -lole32 -lStrmiids -lavutil -lavcodec
