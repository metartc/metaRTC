...
unix{
 ...
 LIBS += -L$$HOME_BASE/thirdparty/lib -lmetartc2  -lmetartccore2 -lpthread -lasound -ldl  -lssl2 -lcrypto2  -lsrtp2
}
...
win32{
    ...
    LIBS += -lmetartc2  -lmetartccore2 -lksuser -lwinmm  -lole32 -lStrmiids -lsrtp2 -lavutil -lavcodec
