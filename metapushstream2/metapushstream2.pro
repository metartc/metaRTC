...
unix{
 ...
 LIBS += -L$$HOME_BASE/thirdparty/lib -lmetartc2  -lmetartccore2 -lspeexdsp -lpthread -lasound -ldl  -lssl2 -lcrypto2  -lsrtp2
}
...
win32{
    ...
    LIBS += -lmetartc2  -lmetartccore2 -lspeexdsp -lksuser -lwinmm  -lole32 -lStrmiids -lsrtp2 -lavutil -lavcodec
