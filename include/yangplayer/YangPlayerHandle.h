...
public:
	...
	virtual int play(std::string url)=0;
	virtual int32_t playRtc(int32_t puid,std::string localIp, std::string server, int32_t pport,std::string app,std::string stream)=0;
