...
typedef struct {
	...
	void (*initIn)(void* context,int32_t psample,int32_t pchannel);
	void (*initOut)(void* context,int32_t psample,int32_t pchannel);
	void (*init)(void* context,int32_t insample,int32_t inchannel,int32_t outsample,int32_t outchannel,int32_t ms);
	int32_t (*resample)(void* context,YangFrame* audioFrame);
}YangAudioResample;
#ifdef __cplusplus
extern "C" {
#endif
