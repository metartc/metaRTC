...
void yang_create_streamHandle(int32_t transType,YangStreamHandle* streamHandle,int32_t puid,YangAVInfo* pcontext,YangContextStream* stream,YangReceiveCallback* callback);
