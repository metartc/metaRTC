...
struct YangVideoMeta {
	int32_t isInit;
	struct YangH2645Conf mp4Meta;
	//YangRtmpMeta flvMeta;
	struct YangRtmpMeta livingMeta;
};
...
typedef struct YangStreamConfig {
	...
	int32_t serverPort;
	int32_t uid;
	enum YangStreamOptType streamOptType;
}YangStreamConfig;
#ifdef __cplusplus
extern "C"{
