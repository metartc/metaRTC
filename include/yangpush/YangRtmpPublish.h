...
//
#ifndef SRC_YANGMEETING_INCLUDE_YangRtmpPublish_H_
#define SRC_YANGMEETING_INCLUDE_YangRtmpPublish_H_
...
#include <vector>
using namespace std;
class YangRtmpPublish: public YangThread {
public:
	YangRtmpPublish(YangContext *pcontext);
	virtual ~YangRtmpPublish();
...
#endif /* SRC_YANGMEETING_INCLUDE_YangRtmpPublish_H_ */
