...
unix{
 ...
 LIBS += -lmetartc4  -lmetartccore4 -lspeexdsp -lavutil -lavcodec -lpthread -lasound -ldl
    #openssl
...
win32{
    ...
    LIBS +=  -lmetartc4  -lmetartccore4 -lspeexdsp -lwinmm -ldmoguids -lole32 -lStrmiids
    ...
    msvc{
        ...
        YANG_LIB=  -L$$HOME_BASE/thirdparty/lib/win/msvc -lavutil -lavcodec -lavrt   -lpthreadVC2  -luser32 -lAdvapi32
        #openssl
