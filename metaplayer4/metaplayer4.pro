...
unix{
 ...
 LIBS += -lmetartc4  -lmetartccore4 -lspeexdsp -lopus -lopenh264 -lpthread -lasound -ldl
    #openssl
...
win32{
    ...
    LIBS += -lmetartc4  -lmetartccore4 -lspeexdsp -lopenh264 -lopus -lavutil -lavcodec -lwinmm -ldmoguids -lole32 -lStrmiids
