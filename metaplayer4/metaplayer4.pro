...
unix{
 ...
 LIBS += -lmetartc4  -lmetartccore4 -lspeexdsp -lopus -lopenh264 -lusrsctp -lpthread -lasound -ldl
    #openssl
...
win32{
    ...
    LIBS += -lmetartc4  -lmetartccore4 -lspeexdsp -lopenh264 -lopus -lusrsctp -lavutil -lavcodec -lwinmm -ldmoguids -lole32 -lStrmiids
