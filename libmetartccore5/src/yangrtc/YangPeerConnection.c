...
void yang_create_peerConnection(YangPeerConnection* peerconn){
	...
	peerconn->on_audio=g_yang_pc_publishAudio;
	peerconn->on_video=g_yang_pc_publishVideo;
	peerconn->on_message=g_yang_pc_publishMsg;
	peerconn->isConnected=g_yang_pc_getState;
