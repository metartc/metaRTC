...
int32_t (*on_audio)(void *session,YangPushH264Rtp* rtp,YangFrame* audioFrame);
int32_t (*on_spspps)(void *session,YangPushH264Rtp* rtp,YangFrame* videoFrame);
}YangPushH264;


void yang_create_pushH264(YangPushH264* push,YangRtpBuffer* audioBuffer,YangRtpBuffer* videoBuffer);
