...
int32_t yang_bandwidth_checkByRR(YangBandwidthSession* bw,YangRtcStats* stats){
	...
	int32_t lostCount=stats->recvStats.video.lostVideoPacketCount-stats->recvStats.video.preLostVideoPacketCount;
	...
	stats->recvStats.video.preLostVideoPacketCount=stats->recvStats.video.lostVideoPacketCount;
