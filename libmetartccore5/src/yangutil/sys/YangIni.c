...
void yang_ini_initAudio(char* filename,YangAudioInfo* audio){
	...
	audio->usingMono=yang_ini_readIntValue(filename,"audio", "usingMono", 0);
	audio->hasAec = yang_ini_readIntValue(filename,"audio", "hasAec", 0);
	...
	audio->hasAudioHeader = yang_ini_readIntValue(filename,"audio", "hasAudioHeader", 0);
...
void yang_ini_initSys(char* filename,YangSysInfo *sys){
	...
	sys->isMultCamera = yang_ini_readIntValue(filename,"sys", "isMultCamera", 0);
	sys->usingDataServer = yang_ini_readIntValue(filename,"sys", "usingDataServer", 0);
	...
	sys->hasLogFile=yang_ini_readIntValue(filename,"sys", "hasLogFile", 0);
...
void yang_ini_initRtc(char* filename,YangRtcInfo *rtc){
	...
	rtc->usingDatachannel = yang_ini_readIntValue(filename,"rtc", "usingDatachannel", 1);
	rtc->hasIceServer = yang_ini_readIntValue(filename,"rtc", "hasIceServer", 0);
	rtc->iceUsingLocalIp = yang_ini_readIntValue(filename,"rtc", "iceUsingLocalIp", 0);
	rtc->iceStunPort = yang_ini_readIntValue(filename,"rtc", "iceStunPort", 3478);
	rtc->audioQueueCount = yang_ini_readIntValue(filename,"rtc", "audioQueueCount", 5);
