...
unix{
 ...
 LIBS += -L$$HOME_BASE/thirdparty/lib -lmetartc6  -lmetartccore6  -lyuv -lopus -lopenh264 -lspeexdsp -lusrsctp -lpthread -lasound -ldl
#openssl
...
win32{
    ...
    LIBS += -lmetartc6 -lmetartccore6 -lyuv -lopus -lopenh264  -lspeexdsp -lavutil -lavcodec -lusrsctp -lksuser -lwinmm  -lole32 -lStrmiids
