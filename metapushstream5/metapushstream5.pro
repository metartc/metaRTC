...
unix{
 ...
 LIBS += -L$$HOME_BASE/thirdparty/lib -lmetartc5  -lmetartccore5 -lyuv -lopenh264 -lspeexdsp -lopus -lusrsctp -lpthread -lasound -ldl
#openssl
...
win32{
    ...
    LIBS += -lmetartc5  -lmetartccore5 -lyuv -lopenh264 -lspeexdsp -lopus -lavutil -lavcodec -lusrsctp -lksuser -lwinmm  -lole32 -lStrmiids
