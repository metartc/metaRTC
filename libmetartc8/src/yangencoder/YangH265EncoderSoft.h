...
public:
	...
	static void initX265Param(YangVideoInfo *videoInfo,YangVideoEncInfo *encInfo,x265_param *param);
...
private:
	...
	void sendAu(YangFrame* videoFrame,YangEncoderCallback* callback);
